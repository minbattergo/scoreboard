...
class App extends React.Component {
  ...
  handleAddPlayer = (name) => {
    //name을 가진 player객체를 this.state.player객체를 배열에 추가 한다.
    console.log(name);
    //{name: 'PARK', score: 60, id: 4},

    this.setState(prevState=> {
      //return {player: prevState.players.push(player)}
      const player = {name, score:0, id: ++this.maxId}; // short hand property(키와벨류가 동일시 생략)
